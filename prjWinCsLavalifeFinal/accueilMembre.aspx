<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="accueilMembre.aspx.cs" Inherits="prjWinCsLavalifeFinal.accueilMembre" %>
    ...
    <form id="form1" runat="server">
        ...
        <ui class="mainMenu">
            <li class="item" id="account">
                ...
                <div class="subMenu">
                    <a href="envoyerMessage.aspx">Send a message</a>
                    <a href="reception.aspx">Messages</a>
                    <a href="recherche.aspx">Research</a>
                </div>
            </li>
            <li class="item" id="about">
                <a href="#about" class="btn"><i class="fas fa-address-card"></i>Follow</a>
                <div class="subMenu">
                    <a href="http://www.facebook.com/lavalife">Facebook</a>
                    <a href="http://www.twitter.com/lavalife">Twitter</a>
                    <a href="http://www.instagram.com/lavalifedotcom">Instagram</a>
                </div>

            </li>

            <li class="item">
                <a href="index.aspx" class="btn"><i class="fas fa-sign-out-alt"></i>Log Out</a>
            </li>
        </ui>
    </div>
