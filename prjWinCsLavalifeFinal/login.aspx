<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="login.aspx.cs" Inherits="prjWinCsLavalifeFinal.login" EnableEventValidation="false" %>
	    	...
	    	<div class="row login-holder">
	    		...
	    		<div class="col-lg-4 col-md-4 col-sm-12" id="login">
	    				...
	    				<div class="step-content">
                            ...
                            <form id="form1" runat="server" >
								<div>
									<table class="auto-style1">
										<tr>
											<td>
                                                <asp:Label ID="Label1" runat="server" Text="Email adresse"></asp:Label>
											</td>
										</tr>
										<tr>
											<td>
                                                <asp:TextBox ID="txtEmail" runat="server" Width="300px"></asp:TextBox>
                                                <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ErrorMessage="Please enter your email" ForeColor="#FF3300" ControlToValidate="txtEmail"></asp:RequiredFieldValidator>
											</td>
										</tr>
										<tr>
											<td>
										...
										<tr>
											<td>
                                                ...
                                                <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ErrorMessage="Please enter your password" ForeColor="#FF3300" ControlToValidate="txtPassword"></asp:RequiredFieldValidator>
											</td>
										</tr>
										<tr>
											<td>
                                                <asp:Button ID="btnConnecter" runat="server" Text="LOGIN" BackColor="#FF3300" ForeColor="White" Width="300px" OnClick="btnConnecter_Click"/>
											</td>
										</tr>
										<tr>
											<td>
                                                <asp:Label ID="lblResultat" runat="server" ForeColor="#FF3300"></asp:Label>
											</td>
										</tr>
										<tr>
											<td>
							...
							<div id="" style="text-align: center; margin-top: 25px; margin-bottom:25px;color:#757575;">Not a member yet? <strong><a href="inscription.aspx">Sign Up.</a></strong></div>
