...
app.run(function ($rootScope) {
    ...
    */
    ...
    $rootScope.PRIVATE_TEASER_STATUSES = {
        ...
        PAID_Y_N_Y      : { id : 4 , action_id  : 4, text : "<h4>Only Matches can see each other’s private photos.</h4> <p>You’ve already liked this profile. Send a message or check back soon.</p>" },
        ...
        PAID_N_N_Y      : { id : 10, action_id  : 3, text : "<h4>Only Matches can see each other’s private photos.</h4> <p>Send a like to show <span ng-bind-html='getHimOrHer()'></span> you’re interested!</p>" },
        ...
        PAID_N_Y_Y      : { id : 14, action_id  : 3, text : "<h4>Only Matches can see each other’s private photos</h4> <h5>You haven't liked this user back yet!</h5> <p>Send a like to unlock <span ng-bind-html='getHisOrHer()'></span> private photos.</p>" },
        ...
        // PAID_Y_N_Y_SENT : { id : 22, action_id  : 0, text : "<h4>Only Matches can see each other’s private photos.</h4> <p>You have sent a like to this person.</p>" },
        // PAID_N_N_Y_SENT : { id : 23, action_id  : 0, text : "<h4>Only Matches can see each other’s private photos.</h4> <p>You have sent a like to this person.</p>" },
        // PAID_N_Y_Y_SENT : { id : 24, action_id  : 0, text : "<h4>Only Matches can see each other’s private photos</h4> <p>You have sent a like to this person.</p>" }
    };
	...
	$rootScope.reasons = [
		{ letter: "6", name: "I’ve met someone through Lavalife.com"},
		{ letter: "7", name: "I’ve met someone through another online dating site"},
		{ letter: "8", name: "I haven’t had any luck on Lavalife.com and need a break"},
		{ letter: "9", name: "I’m considering switching to another online dating site"},
		{ letter: "10", name: "I’d prefer not to say"},
...
app.factory('Page', function() {
   var title = 'Dashboard';
   var append = " – Lavalife.com Online Dating Site & Mobile Apps – Where Singles Click®";
   return {
