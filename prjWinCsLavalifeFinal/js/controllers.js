    ...
    var tutorialStart = function () {    
			...
			if(isFrench == 'fr'){
				...
				tour.addStep({
				  ...
				  content: "Premièrement consulter votre <b>tableau de bord</b>. C’est ici que vous pouvez régler vos préférences de recherche et voir toutes vos ressemblances.",
				...
				tour.addStep({
				  ...
				  content: "Cliquez sur un profil pour voir la version en miniature de celui-ci au côté gauche du profil, de sorte que vous pouvez envoyer un message rapide, les aimer, ou aussi les ajouter à votre liste de favoris, tout en continuant à parcourir le site.<br><br>Voulez-vous voir une version plus complète? Eh bien cliquez sur « Voir le profil » pour voir plus. N’oubliez pas de vérifier l’option «Caractéristiques Communes», allez à la vue générale du profil pour voir ce que vous avez en commun pour un brise-glace rapide!",
				  template: "<div class='popover'><a class='skip-tutorial' data-role='end'>&raquo; FIN</a><div class='arrow'></div><div class='popover-title'></div><div class='popover-content'></div><a data-role='next' class='redBtn'>NEXT</a></div>"
				});
				...
				tour.addStep({
				  ...
				  content: "Ici vous trouverez le <b>Barre Principale de Navigation</b>. Cliquez sur rubrique <b>Home (maison)</b> de n’importe où dans le site pour revenir à votre tableau de bord, ou visitez notre blog Lavalife, vous trouverez également votre profil et tous les paramètres de votre compte dans cet endroit.",
				  template: "<div class='popover'><a class='skip-tutorial' data-role='end'>&raquo; FIN</a><div class='arrow'></div><div class='popover-title'></div><div class='popover-content'></div><a data-role='next' class='redBtn'>NEXT</a></div>"
				});
				...
				tour.addStep({
				  ...
				  content: "Une fois que vous commencez à utiliser le réseau, toutes vos activités peuvent être trouvées ici dans votre <b>Barre d’Outils Principale</b>. Cliquez sur chaque icône pour vérifier : les nouveau messages, les messages envoyés, qui vous a aimé, et aussi vérifiez votre liste de favoris. Votre liste de favoris ne pas divulguée aux autres, il est un endroit idéal pour vous de placer les profils que vous désirez revoir facilement bien après.",
				...
				tour.addStep({
				  ...
				  "<p>We’ve put together a quick tutorial to show you how the site works. Would you like to see it?</p><div class='col-xs-6'><a data-role='next' class='redBtn' style='width:100%;'>YES</a></div><div class='col-xs-6'><a data-role='end' class='redBtn cancel' style='width:100%;'>NO THANKS</a></div></div>"
				});
				...
				tour.addStep({
				  ...
				  title: "Search Bar",
				  placement: "bottom",
				  content: "This is your search bar. When you apply Advanced Search filters, you’ll see a number beside the Advanced Search to show you how many are currently applied.",
				...
				tour.addStep({
				  ...
				  backdrop: true,
				  title: "Sneak Peek",
				  content: "This is where you can get a sneak peek at a profile that interests you. Don’t worry, looking at a user’s Sneak Peek doesn’t show them you’ve viewed them!",
				  template: "<div class='popover'><a class='skip-tutorial' data-role='end'>&raquo; Skip Tutorial</a><div class='arrow'></div><div class='popover-title'></div><div class='popover-content'></div><a data-role='next' class='redBtn'>OK, GOT IT</a></div>"
				});
...
app.constant('PURCHASE_REQUEST_MESSAGE', {
    ...
    'PURCHASING'     : 'Please wait a moment while we process your transaction. Don’t close this page!',
    'CONTINUE'       : 'CONTINUE'
});
